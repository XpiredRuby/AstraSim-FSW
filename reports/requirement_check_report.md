...
| FSW-REQ-002 | PASS | Verified | basic_command_fault |
| FSW-REQ-003 | PASS | Verified | invalid_transition_rejected |
| FSW-REQ-004 | PASS | Verified | basic_command_fault |
| FSW-REQ-005 | PASS | Verified | basic_command_fault |
...
| FSW-REQ-106 | PASS | Verified | basic_command_fault, invalid_transition_rejected, sensor_timeout_safe_mode, watchdog_timeout_safe_mode |
| VER-REQ-001 | MANUAL | Verified | `ci/run_local_tests.sh` |
| VER-REQ-002 | PASS | Verified | basic_command_fault, invalid_transition_rejected, sensor_timeout_safe_mode, watchdog_timeout_safe_mode |
